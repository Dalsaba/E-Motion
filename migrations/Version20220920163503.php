 ...
 */
final class Version20220920163503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, adresse VARCHAR(255) NOT NULL, telephone INT NOT NULL, numero_permis VARCHAR(15) NOT NULL, UNIQUE INDEX UNIQ_C7440455E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, client_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', date_de_debut DATE NOT NULL, date_de_fin DATE NOT NULL, prix INT NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_5E9E89CBDC2902E0 (client_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicule (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', classe_id INT DEFAULT NULL, immatricule VARCHAR(255) NOT NULL, marque VARCHAR(255) NOT NULL, modele VARCHAR(255) NOT NULL, num_serie VARCHAR(255) NOT NULL, couleur VARCHAR(255) NOT NULL, nb_kilometre INT NOT NULL, date_achat DATETIME NOT NULL, prix_achat INT NOT NULL, INDEX IDX_292FFF1D8F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
